...
to get-payoff
  ...
  if noise? and  random(99) + 1 < noise-factor [ ;; Si la bandera de noise esta prendida y el numero random esta dentro de la probabilidad agrega ruido
...
"defect" 1.0 0 -14070903 true "" "plot count turtles with [strategy = \"defect\"]"
"tit-for-tat" 1.0 0 -13840069 true "" "plot count turtles with [strategy = \"tit-for-tat\"]"
"unforgiving" 1.0 0 -15302303 true "" "plot count turtles with [strategy = \"unforgibing\"]"
"unknown" 1.0 0 -7858858 true "" "plot count turtles with [strategy = \"unknown\"]"
